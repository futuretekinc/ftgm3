...
LIBS += -lshellftgm -lftgm -lmosquitto -lhl++ ../../cortina/KompexSQLiteWrapper-Source_1.11.14/lib/debug/KompexSQLiteWrapper_Static_d.a -ljson -lnetsnmp -lpthread -ldl
else
ifeq ($(TARGET), "FTM-50")
...
LIBS += -lshellftgm -lftgm -lmosquitto -lhl++ ../../spear/KompexSQLiteWrapper-Source_1.11.14/lib/debug/KompexSQLiteWrapper_Static_d.a -ljson -lnetsnmp -lpthread -ldl
else
