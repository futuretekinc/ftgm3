...
static const char*	class_name = "DeviceDF868_01";

DeviceDF868_01::DeviceDF868_01(ObjectManager& _manager)
: DeviceModbus(_manager, OBJECT_TYPE_DEV_DF868_01, true), correction_interval_(1)
{
...
DeviceDF868_01::DeviceDF868_01(ObjectManager& _manager, JSONNode const& _properties)
: DeviceModbus(_manager, OBJECT_TYPE_DEV_DF868_01, true), correction_interval_(1)
{
	TRACE_INFO("DF868_01 Created");
...
const char*	DeviceDF868_01::GetClassName()
{
	return	class_name;
}

bool	DeviceDF868_01::ReadValue(std::string const& _epid, time_t& _time, std::string& _value)
{
	try
	{
		...
		if ((index > DF868_01_SENSOR_COUNT))
		{
...
std::string* DeviceDF868_01::strSplit(std::string strOrigin, std::string strTok, int size)
{
	int cutAt;
	int index = 0;
...
double DeviceDF868_01::cal_data(double mantissa, double exponent)
{
...
void	DeviceDF868_01::Preprocess()
{
	DeviceModbus::Preprocess();
}

void	DeviceDF868_01::Process()
{
	uint8_t slave_id = 0;
	float p = 0;
	...
	std::string* temp;
	size_t ex_size = 0;	
	uint8_t serial_command[DF868_01_SENSOR_COUNT][12] = {
	...
	if(correction_timer_.RemainTime() == 0)
	{
		...
		TRACE_INFO("DF868_01 read data");
#if 1
		for(uint8_t i = 0 ; i < DF868_01_SENSOR_COUNT ; i++)
		{
		...
		TRACE_INFO("DF868_01 Remain Time : " << correction_timer_.RemainTime());
...
////////////////////////////////////////////////////////////////////////////////
const char*	DeviceDF868_01::Type()
{
	return	OBJECT_TYPE_DEV_DF868_01;
}
