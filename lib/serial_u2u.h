#ifndef	SERIAL_U2U_H_
#define	SERIAL_U2U_H_
...
public:
	Serialu2u();
	Serialu2u(std::string const& _port, uint32_t _baudrate, uint32_t _data_bit, std::string const& _parity_bit);
	Serialu2u(std::string const& _comm_port, std::string const& _ctrl_port, uint32_t _baudrate, uint32_t _data_bit, std::string const& _parity_bit);
