...
extern	double		ACTIVE_OBJECT_LOOP_INTERVAL;
...
#define	RCS_CLIENT_INIT_TIMEOUT		100	// ms
...
TITLE_NAME(ACTION, "action");
TITLE_NAME(ACTIONS, "actions");
...
TITLE_NAME(CONDITION, "condition");
TITLE_NAME(CONDITIONS, "conditions");
