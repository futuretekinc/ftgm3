...
RCSSession::RCSSession(TCPServer *_server, int	_socket, struct sockaddr_in *_addr_info, uint32_t _timeout)
...
void	RCSSession::OnMessage(Message* _base_message)
{
...
JSONNode	RCSSession::RequestParse(const char* _message)
{
...
bool	RCSSession::Call(JSONNode& _request, JSONNode& _response)
{
	bool	result = false;
...
void	RCSSession::Postprocess()
{
	ActiveObject::Postprocess();
}


void	RCSSession::SetObjectManager(ObjectManager*	_object_manager)
{
