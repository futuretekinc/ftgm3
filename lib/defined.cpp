...
uint32_t	ENDPOINT_SENSOR_VOLTAGE_MAX		= 	(380);
uint32_t	ENDPOINT_SENSOR_VOLTAGE_MIN		= 	(0);
const char*	ENDPOINT_SENSOR_VOLTAGE_UNIT	= 	"V";

uint32_t	ENDPOINT_SENSOR_CURRENT_MAX		= 	(100);
uint32_t	ENDPOINT_SENSOR_CURRENT_MIN		= 	(0);
